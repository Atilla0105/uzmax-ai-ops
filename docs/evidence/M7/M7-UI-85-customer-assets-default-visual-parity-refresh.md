...
| `PATH=/tmp/uzmax-node-runtime/node-v24.18.0-darwin-arm64/bin:$PATH node scripts/guards/pr-shape.mjs --base codex/m7-ui-84-orders-default-visual-parity-refresh --spec docs/specs/M7-UI-85-customer-assets-default-visual-parity-refresh.md --include-worktree` | pass | `changedFiles=11`; `source.changedFiles=3`; `source.netLoc=0`; `test=3`; `docs=4`; `config=1`. |

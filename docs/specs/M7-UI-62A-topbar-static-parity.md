...
在 `origin/codex/m7-ui-31-orders-visible-ui` + M7-UI-58/M7-UI-59 clean-stack base 上，重放一版小而可见的共享 AppShell topbar 静态视觉基线，严格对齐 owner 输入（`/Users/atilla/Downloads/运营塔台1.0.html` 与 `unpacked 6`）的上层结构与文案，不进行页面体迁移。
...
- Base: `origin/codex/m7-ui-31-orders-visible-ui` at `32ee788f83f3d656dd94133c4b9a810c717875a6`
- 读文件前置与上下文：
  - `AGENTS.md`

...
export const tenantLogRuntimeBoundary = tenantLogRuntimeLabels.join(" | ");
...
export const tenantLogStateCopy: Record<
  TenantLogViewState,
  { body: string; title: string }
> = {
  degraded: {
    body: "当前展示最近可用的日志记录，正式链路恢复后会自动更新。",
    title: "日志记录已就绪"
  },
  empty: {
    body: "当前筛选条件下暂无登录、在线或操作记录。",
    title: "暂无日志记录"
  },
  error: {
    body: "日志数据暂时无法读取，请稍后刷新或切换条件重试。",
    title: "日志暂不可用"
  },
  loading: {
    body: "正在读取登录、在线和操作记录。",
...
export const tenantLogRows: Record<TenantLogTab, TenantLogRow[]> = {
  login: [
    ...
    row("login-3", ["今天 10:30", "王敏", "84.54.72.9", "Safari · iOS", "成功"]),
    row("login-4", [
      "昨天 22:14",
      "李航",
      "95.214.10.2",

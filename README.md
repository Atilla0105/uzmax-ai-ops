...
- `docs/admin-design-system.md`、`PRODUCT.md`、`DESIGN.md`、`docs/evidence/M7/README.md`：当前视觉系统标准源、Impeccable 采纳边界和后续 UI 切片队列；M7+ 字体、颜色、组件、动效与交互以 owner 当前原型 `/Users/atilla/Downloads/运营塔台1.0.html` 和 `/Users/atilla/源码/unpacked 6` 为准，不再继承旧后台 shell 视觉。
...
- `docs/admin-design-system.md`：M7-05 后的视觉系统标准源，服务于 owner 当前原型与 `/Users/atilla/源码/unpacked 6`；旧 `--uzmax-*` / milestone shell 视觉只作为 legacy implementation debt。

...
| UI-05 | M7-UI-05 Layered Navigation Shell | `implementation_pending_pr_review` | `docs/specs/M7-UI-05-layered-navigation-shell.md`; `docs/evidence/M7/M7-UI-05-layered-navigation-shell.md`; focused shell/router tests, legacy `/design` route-entry migration tests and screenshots for group-only vs tenant-only AppShell navigation |

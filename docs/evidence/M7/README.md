...
| UI-11 | M7-UI-11 Release Acceptance Page | `draft_paused_transitional` | `docs/specs/M7-UI-11-release-acceptance-page.md`; `docs/evidence/M7/M7-UI-11-release-acceptance-page.md`; PR #178 is Draft/Paused, spec-only/transitional, no page implementation |

...
export function modelStats(allProvidersResolved: boolean): ModelKpi[] {
  return [
    kpi("SYN-MODEL-KPI-cost", "集团总成本 / 今日", "¥418", "+12%", "warn"),
    kpi("SYN-MODEL-KPI-base", "7 日均 / 日", "¥372", "基线", "neutral"),
    kpi("SYN-MODEL-KPI-latency", "平均延迟", "498ms", "-30ms", "ok"),
    kpi("SYN-MODEL-KPI-failure", "整体失败率", "0.9%", "+0.2%", "warn"),
    allProvidersResolved
      ? kpi("SYN-MODEL-KPI-down", "AllProvidersDown", "0", "已恢复", "ok")
      : kpi("SYN-MODEL-KPI-down", "AllProvidersDown", "1", "白桦母婴", "danger")
  ];
}

...
| 13 | M7-UI-10-confirmation-queue-page | 确认队列 | `/Users/atilla/源码/unpacked 6/pages/queue/QueuePage.tsx` | `tenant.queue` | `apps/admin/src/pages/queue/QueuePage.tsx` | `not_started`; existing confirmation queue runtime remains legacy evidence route; implementation gated until coordinator approves M7-UI-10 | loading, empty, error, permission, degraded, conflict diff | `spec_drafted_pending_coordinator_approval` |

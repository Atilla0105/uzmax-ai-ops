...
| I-01 | `partial_admin_shell_not_closed` | M4-01 adds visible admin order-path status shell, M4-06 extends import/search states and M4-13 adds the admin API client contract; full desktop core order/customer workflow remains future scope. |

...
| UI-07 | M7-UI-07 Page Visual Acceptance Notes | `draft_pr_review` | `docs/specs/M7-UI-07-page-visual-acceptance-notes.md`; `docs/evidence/M7/M7-UI-07-page-visual-acceptance-notes.md`; durable planning notes only: owner HTML and frozen unpacked page source are the hard visual/source baseline; #182 is broadly aligned but not accepted or merge-ready |

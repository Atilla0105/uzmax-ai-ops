...
| UI-04A+ | Page migration implementation queue | `page_specific_specs_required` | UI-10 is merged, UI-11 is implementation-pending PR review with group/tenant layer separation recorded as an unresolved shell/IA follow-up; subsequent page implementations still require approved page-specific specs, runtime contracts, state matrices, tests and evidence |

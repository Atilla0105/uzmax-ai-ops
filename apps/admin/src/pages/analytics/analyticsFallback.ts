...
export const analyticsRanges = [
  ...
  { factor: 1, id: "7d", label: "近7日" },
  { factor: 4.2, id: "30d", label: "近30日" }
] as const;
export const analyticsDimDefs: Record<
  AnalyticsDimension,
  { label: string; values: string[] }
> = {
  agent: { label: "AI 成员", values: ["主理 AI", "夜间值守 AI"] },

...
Current-state note: as of M7-01, `guard:doc-triggers` hard-checks the evals and contracts documentation entries only. Release, observability, environment, issue-template and skill rows remain manual governance unless a later spec expands guard scope.

...
| 13 | M7-UI-04M-tenant-queue | 确认队列 | `/Users/atilla/源码/unpacked 6/pages/queue/QueuePage.tsx` | `tenant.queue` | `apps/admin/src/pages/queue/QueuePage.tsx` | `not_started`; existing confirmation queue runtime remains legacy evidence route | loading, empty, error, permission, degraded, conflict diff | `not_started` |

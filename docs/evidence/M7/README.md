...
| UI-08 | M7-UI-08 Shared Sidebar Calibration | `implementation_pending_validation` | `docs/specs/M7-UI-08-shared-sidebar-calibration.md`; `docs/evidence/M7/M7-UI-08-shared-sidebar-calibration.md`; shared AppShell/sidebar grouping and collapse calibration only; no page migration, PR #182 merge, owner acceptance or release approval |

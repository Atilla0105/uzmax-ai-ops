...
| `node --test scripts/tests/m3-pricing-capability-and-quote-record-contract.test.mjs` | PASS: 6/6 tests passed |
...
| `git diff --check` | PASS |
| `npm run check` | PASS: format, typecheck, lint, depcruise, jscpd, knip, guards, 101 node tests, build, size-limit and 6 Playwright tests passed |
